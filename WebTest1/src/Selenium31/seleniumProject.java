...
public class seleniumProject {
	...
	public static void m4()
	{
		...
		obj.adminLogin();
		driver.findElement(By.linkText("Manufacturers")).click();
		String mCount1 = driver.findElement(By.xpath("//*[@id='contentText']/table/tbody/tr[2]/td/table/tbody/tr/td[1]/table/tbody/tr[22]/td/table/tbody/tr/td[1]/strong[3]")).getText();
